...
---
### kill
* 시스템상에서 동작하고 있는 프로세스에 특정 신호를 보내는 명령어
* 일반적으로 종료되지 않는 프로세스를 종료시킬 때 사용
* `kill [옵션 or 시그널] PID`
* 시그널 리스트 확인 `kill -l`

<img src="https://user-images.githubusercontent.com/97163113/172041503-ab1e875f-6b13-4bf9-b109-093650118bfc.png" width="70%" height="70%">
